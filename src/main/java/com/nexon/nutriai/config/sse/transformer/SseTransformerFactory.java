...
public class SseTransformerFactory {
    ...
    public SseTransformerFactory(OpenAiSseTransformer openAiTransformer, BasicSseTransformer basicTransformer, NoneTransformer noneTransformer) {
     ...
     * @return 对应的转换器实例，如果未找到则返回 Basic 转换器作为默认值。
     */
